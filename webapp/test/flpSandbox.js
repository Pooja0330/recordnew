		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nonconformanceodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nonconformanceodata-display": {
								"semanticObject": "nonconformanceodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nonconformanceodata",
									"url": sap.ui.require.toUrl("nonconformanceodata")
								}
							}
						}
					}
